...
int sMultiple::generarNumeroAleatorio()
{
    int random = rand() % 20; 
...
sMultiple::sMultiple(int num_Pregunta)
{
    read ();
...
void sMultiple::read(){
    ifstream file("BancoPreguntas/SeleccionMultiple.txt");
...
bool sMultiple::revisar(string resRecibida, int random)
{
